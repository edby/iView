  ...
  <div v-title="title">
    ...
    <div class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted">
      <div class="mui-scroll">
        ...
        <router-link to="/user/order/orderdelivergoods" class="mui-control-item mui-active" replace>待发货</router-link>
...
export default {
  ...
  created() {
    ...
    this.$axios.get("/user/order/index?status=2").then(res => {
      // console.log(res)
